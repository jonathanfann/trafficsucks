...
app.get('/', function (req, res) {
    baseUrl = trafficViewApiUrl + '&system=SCDOT&format=rf-json';
    console.log(req.params);
    getData(function(err, data) {
        var myObj = JSON.parse(data.body);
        var myHtml = '<html><head><link href="//fonts.googleapis.com/css?family=Eczar" \
        rel="stylesheet"><style>html,body,h1,h2,h3,h4,h5,p,strong,small {font-family:"Eczar" !important; } \
        html,body { margin:0; padding:0; background:#eeeeee; color:#333333; } h1 { font-size: 40px;}</style> \
        <meta name="viewport" content="width=device-width, initial-scale=1"></head> \
        <body><div style="background:#ffffff; padding:10px 20px;"> \
        <h1>SCDOT Events &amp; Incidents</h1></div><div style="border-top:1px dotted red; padding:20px;">';
